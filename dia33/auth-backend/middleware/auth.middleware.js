...
export const authMiddleware = (req, res, next) => {
    try {
        ...
        //console.log(req.headers['authorization']); // Verificar el encabezado Authorization

        // opcion 1
        // const authHeader = req.headers.authorization;
        // const lista = authHeader.split(" "); // Dividir el encabezado Authorization
        // const token = lista[1]; // Obtener el token del encabezado Authorization
